		...
		struct device_attribute *attr, char *buf)
{
	...
	return sprintf(buf, "\"I2CR_AF\":\"%d\",\"I2CR_COM\":\"%d\",\"I2CR_OIS\":\"%d\","
		...
		struct device_attribute *attr, char *buf)
{
	...
	return sprintf(buf, "\"I2CF_AF\":\"%d\",\"I2CF_COM\":\"%d\",\"I2CF_OIS\":\"%d\","
...
#ifdef USE_CAMERA_HW_BIG_DATA
static DEVICE_ATTR(rear_hwparam, S_IRUGO, rear_camera_hw_param_show, NULL);
static DEVICE_ATTR(front_hwparam, S_IRUGO, front_camera_hw_param_show, NULL);
#endif
